        ...
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm grid md:grid-cols-3 gap-4">
                <div className="relative">
                    ...
                    <select className="w-full pl-10 pr-4 py-3 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-blue-500">
                        <option>From: Megenagna</option>
                        <option>Bole</option>
            ...
            <div className="grid gap-4">
                ...
                {[1, 2].map((i) => (
                    <div key={i} className="bg-white p-5 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-400">
                                <Car size={28} />
                            </div>
                            <div>
                                <p className="font-bold text-gray-900 text-lg">Toyota Coaster <span className="text-xs font-normal text-gray-400 ml-2">AA-3-09876</span></p>
                        ...
                        <div className="text-right">
                            <p className="text-2xl font-black text-gray-900">15 ETB</p>
